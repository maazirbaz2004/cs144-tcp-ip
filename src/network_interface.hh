...
private:
  ...
  struct ArpCacheEntry
  {
    ...
    size_t ttl; //time to live in ms
  };

  //arp cache: ip -> ethernet + TTL
  std::map<uint32_t, ArpCacheEntry> arpCache {};
  std::map<uint32_t, size_t> arpRequestTime {};

  //queue of datagrams waiting for ARP resolution (with their own ttl)
  ...
  std::list<WaitingDatagram> waitingDatagrams {};
};